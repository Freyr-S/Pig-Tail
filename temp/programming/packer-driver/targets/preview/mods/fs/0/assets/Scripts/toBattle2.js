System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ToBattle2", ToBattle2 = (_dec = ccclass('ToBattle2'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inheritsLoose(ToBattle2, _Component);

        function ToBattle2() {
          return _Component.apply(this, arguments) || this;
        }

        var _proto = ToBattle2.prototype;
        ...
        // @property
        // serializableDummy = 0;
        _proto.toBattle2 = function toBattle2() {
