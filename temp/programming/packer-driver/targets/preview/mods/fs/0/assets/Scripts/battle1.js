  ...
  return {
    ...
    execute: function () {
      ...
      _export("Battle1", Battle1 = (_dec = ccclass('Battle1'), _dec2 = property({
        ...
        _inheritsLoose(Battle1, _Component);
        ...
        function Battle1() {
          ...
          _defineProperty(_assertThisInitialized(_this), "player1", (_temp2 = function _temp2() {
          ...
          _defineProperty(_assertThisInitialized(_this), "player2", (_temp3 = function _temp3() {
            _defineProperty(this, "spadel", void 0);
          ...
          _defineProperty(_assertThisInitialized(_this), "p1", new _this.player1());

          _defineProperty(_assertThisInitialized(_this), "p2", new _this.player2());

          _defineProperty(_assertThisInitialized(_this), "temp", -1);

          _defineProperty(_assertThisInitialized(_this), "taillen", 0);

          _defineProperty(_assertThisInitialized(_this), "turn", 1);

          _defineProperty(_assertThisInitialized(_this), "count", 52);

          _defineProperty(_assertThisInitialized(_this), "count1", 89);

          _defineProperty(_assertThisInitialized(_this), "count2", 89);

          _initializerDefineProperty(_assertThisInitialized(_this), "s1", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "h1", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "c1", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "d1", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "s2", _descriptor5, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "h2", _descriptor6, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "c2", _descriptor7, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "d2", _descriptor8, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "red1", _descriptor9, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "red2", _descriptor10, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "green1", _descriptor11, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "green2", _descriptor12, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "time1", _descriptor13, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "t1", _descriptor14, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "time2", _descriptor15, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "t2", _descriptor16, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "hand1", _descriptor17, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "hand2", _descriptor18, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "spade1", _descriptor19, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "spade2", _descriptor20, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "heart1", _descriptor21, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "heart2", _descriptor22, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "club1", _descriptor23, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "club2", _descriptor24, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "diamond1", _descriptor25, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "diamond2", _descriptor26, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "bg_wnode", _descriptor27, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "shipnode", _descriptor28, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "Bg", _descriptor29, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "tail", _descriptor30, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker1", _descriptor31, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker2", _descriptor32, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker3", _descriptor33, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker4", _descriptor34, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker5", _descriptor35, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker6", _descriptor36, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker7", _descriptor37, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker8", _descriptor38, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker9", _descriptor39, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker10", _descriptor40, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker11", _descriptor41, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker12", _descriptor42, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker13", _descriptor43, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker14", _descriptor44, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker15", _descriptor45, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker16", _descriptor46, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker17", _descriptor47, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker18", _descriptor48, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker19", _descriptor49, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker20", _descriptor50, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker21", _descriptor51, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker22", _descriptor52, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker23", _descriptor53, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker24", _descriptor54, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker25", _descriptor55, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker26", _descriptor56, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker27", _descriptor57, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker28", _descriptor58, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker29", _descriptor59, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker30", _descriptor60, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker31", _descriptor61, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker32", _descriptor62, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker33", _descriptor63, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker34", _descriptor64, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker35", _descriptor65, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker36", _descriptor66, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker37", _descriptor67, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker38", _descriptor68, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker39", _descriptor69, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker40", _descriptor70, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker41", _descriptor71, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker42", _descriptor72, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker43", _descriptor73, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker44", _descriptor74, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker45", _descriptor75, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker46", _descriptor76, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker47", _descriptor77, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker48", _descriptor78, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker49", _descriptor79, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker50", _descriptor80, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker51", _descriptor81, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "poker52", _descriptor82, _assertThisInitialized(_this));

          return _this;
        }

        var _proto = Battle1.prototype;
        ...
        _proto.callback1 = function callback1() {
          if (this.count1 >= 1) {
            if (this.count1 != 0) {
        ...
        _proto.callback2 = function callback2() {
          if (this.count2 >= 1) {
            if (this.count2 != 0) {
        ...
        _proto.stopTimeCutdown1 = function stopTimeCutdown1() {
          this.unschedule(this.callback1);
        };

        _proto.stopTimeCutdown2 = function stopTimeCutdown2() {
          this.unschedule(this.callback2);
        };

        _proto.reset1 = function reset1() {
        ...
        _proto.startTime1 = function startTime1() {
        ...
        _proto.startTime2 = function startTime2() {
                  ...
                  setTimeout(function () {
                    switch (self2.name) {
                      case "spade":
                        ...
                        _this2.Bg.removeChild(self2);

                        _this2.p1.spaden.addChild(self2);

                        self2.parent = _this2.p1.spaden;
                        _this2.p1.spadel++;
                        _this2.p1.spadelen++;
                      ...
                      case "heart":
                        ...
                        _this2.p1.heartn.addChild(self2);

                        self2.parent = _this2.p1.heartn;
                        _this2.p1.heartl++;
                        _this2.p1.heartlen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                      ...
                      case "club":
                        ...
                        _this2.p1.clubn.addChild(self2);

                        self2.parent = _this2.p1.clubn;
                        _this2.p1.clubl++;
                        _this2.p1.clublen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                      ...
                      case "diamond":
                        ...
                        _this2.p1.diamondn.addChild(self2);

                        self2.parent = _this2.p1.diamondn;
                        _this2.p1.diamondl++;
                        _this2.p1.diamondlen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                  ...
                  setTimeout(function () {
                    switch (self2.name) {
                      case "spade":
                        ...
                        _this3.Bg.removeChild(self2);

                        _this3.p2.spaden.addChild(self2);

                        self2.parent = _this3.p2.spaden;
                        _this3.p2.spadel++;
                        _this3.p2.spadelen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                      ...
                      case "heart":
                        ...
                        _this3.p2.heartn.addChild(self2);

                        self2.parent = _this3.p2.heartn;
                        _this3.p2.heartl++;
                        _this3.p2.hratelen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                      ...
                      case "club":
                        ...
                        _this3.p2.clubn.addChild(self2);

                        self2.parent = _this3.p2.clubn;
                        _this3.p2.clubl++;
                        _this3.p2.clublen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
                      ...
                      case "diamond":
                        ...
                        _this3.p2.diamondn.addChild(self2);

                        self2.parent = _this3.p2.diamondn;
                        _this3.p2.diamondl++;
                        _this3.p2.diamondlen++;
                        self2.active = false; //隐藏该扑克牌
                        //},1000)
        ...
        _proto.playspade1 = function playspade1() {
          var _this4 = this;
          ...
          if (this.p1.spadelen > 0) {
            ...
            setTimeout(function () {
              ...
              _this4.Bg.removeChild(self3);

              self3.parent = _this4.tail; //把该牌挂到放置区上

              _this4.tail.addChild(self3);

              _this4.taillen++;
              _this4.temp++;

              _this4.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.playspade2 = function playspade2() {
          var _this5 = this;
          ...
          if (this.p2.spadelen > 0) {
            ...
            setTimeout(function () {
              ...
              _this5.Bg.removeChild(self3);

              self3.parent = _this5.tail; //把该牌挂到放置区上

              _this5.tail.addChild(self3);

              _this5.taillen++;
              _this5.temp++;

              _this5.judge(); //判断花色是否和顶部花色一样
              //暂停倒计时，重置倒计时
        ...
        _proto.playheart1 = function playheart1() {
          var _this6 = this;
          ...
          if (this.p1.heartlen > 0) {
            ...
            setTimeout(function () {
              ...
              _this6.Bg.removeChild(self3);

              self3.parent = _this6.tail; //把该牌挂到放置区上

              _this6.tail.addChild(self3);

              _this6.taillen++;
              _this6.temp++;

              _this6.judge(); //判断花色是否和顶部花色一样
              //暂停倒计时，重置倒计时
        ...
        _proto.playheart2 = function playheart2() {
          var _this7 = this;
          ...
          if (this.p2.heartlen > 0) {
            ...
            setTimeout(function () {
              ...
              _this7.Bg.removeChild(self3);

              self3.parent = _this7.tail; //把该牌挂到放置区上

              _this7.tail.addChild(self3);

              _this7.taillen++;
              _this7.temp++;

              _this7.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.playclub1 = function playclub1() {
          var _this8 = this;
          ...
          if (this.p1.clublen > 0) {
            ...
            setTimeout(function () {
              ...
              _this8.Bg.removeChild(self3);

              self3.parent = _this8.tail; //把该牌挂到放置区上

              _this8.tail.addChild(self3);

              _this8.taillen++;
              _this8.temp++;

              _this8.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.playclub2 = function playclub2() {
          var _this9 = this;
          ...
          if (this.p2.clublen > 0) {
            ...
            setTimeout(function () {
              ...
              _this9.Bg.removeChild(self3);

              self3.parent = _this9.tail; //把该牌挂到放置区上

              _this9.tail.addChild(self3);

              _this9.taillen++;
              _this9.temp++;

              _this9.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.playdiamond1 = function playdiamond1() {
          var _this10 = this;
          ...
          if (this.p1.diamondlen > 0) {
            ...
            setTimeout(function () {
              ...
              _this10.Bg.removeChild(self3);

              self3.parent = _this10.tail; //把该牌挂到放置区上

              _this10.tail.addChild(self3);

              _this10.taillen++;
              _this10.temp++;

              _this10.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.playdiamond2 = function playdiamond2() {
          var _this11 = this;
          ...
          if (this.p2.diamondlen > 0) {
            ...
            setTimeout(function () {
              ...
              _this11.Bg.removeChild(self3);

              self3.parent = _this11.tail; //把该牌挂到放置区上

              _this11.tail.addChild(self3);

              _this11.taillen++;
              _this11.temp++;

              _this11.judge(); //判断花色是否和顶部花色一样
        ...
        _proto.gameover = function gameover() {
          //玩家1获胜，玩家2失败
          var len1 = this.p1.handcardslen;
          var len2 = this.p2.handcardslen;
        ...
        _proto.initCard = function initCard() {
          ...
          this.schedule(function () {
            ...
            card.on(Node.EventType.TOUCH_END, function (event) {
              ...
              _this12.tail.addChild(card);

              card.parent = _this12.tail; //this.Tails[this.temp]=card;

              _this12.temp++; //指向tail节点的子节点的顶部

              _this12.taillen++; //放置区数量加1
              //console.log(this.taillen);

              switch (_this12.p1.is_turn) {
                case true:
                  _this12.red1.active = true;
                  _this12.green1.active = false;
                  _this12.red2.active = false;
                  _this12.green2.active = true;

                  _this12.stopTimeCutdown1();
                  ...
                  _this12.turn = 2;
                  _this12.p1.is_turn = false;
                  _this12.p2.is_turn = true;
                  break;

                case false:
                  _this12.red1.active = false;
                  _this12.green1.active = true;
                  _this12.red2.active = true;
                  _this12.green2.active = false;

                  _this12.stopTimeCutdown2();
                  ...
                  _this12.turn = 1;
                  _this12.p1.is_turn = true;
                  _this12.p2.is_turn = false;
              } //实现翻牌、牌的移动
        ...
        _proto.start = function start() {
          ...
          this.turn = 1;
          setTimeout(function () {
            _this13.bg_wnode.active = false;
            _this13.shipnode.active = false;
          }, 4500);
        ...
        return Battle1;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "s1", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
