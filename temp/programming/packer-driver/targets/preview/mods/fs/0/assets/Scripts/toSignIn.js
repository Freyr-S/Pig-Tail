System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ToSignIn", ToSignIn = (_dec = ccclass('ToSignIn'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inheritsLoose(ToSignIn, _Component);

        function ToSignIn() {
          return _Component.apply(this, arguments) || this;
        }

        var _proto = ToSignIn.prototype;
        ...
        // @property
        // serializableDummy = 0;
        _proto.toSignIn = function toSignIn() {
