    ...
    execute: function () {
      ...
      _export("Bb", Bb = (_dec = ccclass('Bb'), _dec2 = property({
        ...
        function Bb() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "Back", _descriptor5, _assertThisInitialized(_this));
        ...
        _proto.initCard = function initCard() {
          ...
          */
          ...
          var _loop = function _loop() {
            var card = instantiate(_this2.Back);
            Cards = [];

            _this2.Bg.addChild(card);

            card.parent = _this2.Bg;
